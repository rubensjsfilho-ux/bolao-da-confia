      ...
      <div onClick={()=>hasTeams&&!isLocked&&setOpen(o=>!o)}
        ...
        <div style={{ flex:1, minWidth:0 }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:7, marginBottom:6 }}>
            <span style={{ display:'inline-flex', alignItems:'center', width:28, height:20 }}>
              {team1 ? getFlag(team1) : <span style={{fontSize:20}}>🏳️</span>}
            </span>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:7 }}>
            <span style={{ display:'inline-flex', alignItems:'center', width:28, height:20 }}>
              {team2 ? getFlag(team2) : <span style={{fontSize:20}}>🏳️</span>}
            </span>
  ...
  const roundMatches = Array.from({ length:current.matchCount },(_,i) => {
    ...
    const staticInfo = {
      r2:[
        ...
        {city:'Houston',          date:'2026-06-29T17:00:00Z',info:'1º C × 2º F'},
        {city:'Boston',           date:'2026-06-29T20:30:00Z',info:'1º E × 3º ABCDF'},
        {city:'Monterrey',        date:'2026-06-30T01:00:00Z',info:'1º F × 2º C'},
        {city:'Dallas',           date:'2026-06-30T17:00:00Z',info:'2º E × 2º I'},
        {city:'Nova Jersey',      date:'2026-06-30T21:00:00Z',info:'1º I × 3º CDFGH'},
        {city:'Cidade do México', date:'2026-07-01T01:00:00Z',info:'México × 3º CEFHI'},
        {city:'Atlanta',          date:'2026-07-01T16:00:00Z',info:'1º L × 3º EHIJK'},
        {city:'Seattle',          date:'2026-07-01T20:00:00Z',info:'1º G × 3º AEHIJ'},
        {city:'Santa Clara',      date:'2026-07-02T00:00:00Z',info:'EUA × 3º BEFIJ'},
        {city:'Los Angeles',      date:'2026-07-02T19:00:00Z',info:'1º H × 2º J'},
        {city:'Toronto',          date:'2026-07-02T23:00:00Z',info:'2º K × 2º L'},
        {city:'Vancouver',        date:'2026-07-03T03:00:00Z',info:'Suíça × 3º EFGIJ'},
        {city:'Dallas',           date:'2026-07-03T18:00:00Z',info:'2º D × 2º G'},
        {city:'Miami',            date:'2026-07-03T22:00:00Z',info:'Argentina × 2º H'},
